  ...
  <div class="layout-mgt-30">
    ...
    <div v-if="largeContainer" class="largeContainer">
      ...
      <div class="box-image-wrapper fl">
        ...
        <img src="../assets/circle.png" style="height: 30px;margin-top:35px;cursor: pointer;" @click="rotateImg">
        <img src="../assets/circle.png" style="height: 30px;margin-top:35px;cursor: pointer;transform:rotateY(180deg)" @click="rotateImgBack">
      </div>
