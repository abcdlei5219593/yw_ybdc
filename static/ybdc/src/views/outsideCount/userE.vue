         ...
         <el-col :span="8">
           <div class="box">
             <!-- <el-col :span="24" class="box-line">
               <label >下载用户数：</label>&nbsp;&nbsp;  {{countData.downloadCount}} 人 </label>
             </el-col> -->
             <el-col :span="24" class="box-line">
               <label >注册用户数：</label>&nbsp;&nbsp;  {{countData.registerCount}} 人
             </el-col>
             <el-col :span="24" class="box-line">
               <label >押金用户数：</label>&nbsp;&nbsp;  {{countData.depositCount}} 人 </label>
             </el-col>
             <el-col :span="24" class="box-line">
               <label >芝麻信用用户数：</label>&nbsp;&nbsp;  {{countData.zhimaCreditCount}} 人
             </el-col>
           </div>
         </el-col>
