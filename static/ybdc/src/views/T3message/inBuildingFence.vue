            ...
            <div class='table-container layout-mgt-0'>
              <div class="fl">
                ...
                <el-switch
                  ...
                  <span style="margin-left:20px;">城市 :  </span><el-select class="power_select" v-model="selectedCity" style="width:100px;">
                  	<el-option v-for="item in cityList" :key="item.code" :label="item.name" :value="item.code"></el-option>
                  </el-select>
                  <i style="margin:0 20px;" class="el-icon-search font cursor-pointer" @click="bikeSearch"></i>
                </div>
...
export default {
  ...
  watch:{
    isRecovery(value){
      this.recoveryStatus = value == true ? '12' : '';
      console.log(this.recoveryStatus)
    }
  },
  methods:{
    queryCity() {
